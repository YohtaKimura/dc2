...
public class PropertiesDialog extends JDialog {
    ...
    private final SimpleDigitalClock panel;
    ...
    public PropertiesDialog(JFrame owner, SimpleDigitalClock panel) {
        super(owner);
        this.owner = owner;
        this.panel = panel;
        int row = 0;
        ...
        try {
            ...
            prevForeground = DisplayColor.BLACK;
        }
        try {
            prevBackground = DisplayColor.valueOf(panel.getBackground());
        } catch (IllegalArgumentException e) {
            prevBackground = DisplayColor.WHITE;
        }
    ...
    private class PropertiesDialogActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getSource().equals(okButton)) {
                // Save properties
                ConfigurationPreferences conf = Dc2_4.getConfiguration();
